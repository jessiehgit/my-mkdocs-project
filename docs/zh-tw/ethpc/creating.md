...
2. **基本設定**
    ...
    ![基本設定](../../img/ethpc/01建立容器叢集-基本設定.png)
...
3. **資源配置**
    ...
    - 依照訓練需求選擇 **規格** ，若規格選擇 Nvidia 的 GPU，請選擇 CUDA 版本
        ...
        !!! note
            ...
            ![額度](../../img/ethpc/04建立容器叢集-額度.png){:height="40%" width="40%"}

    - 設定共享記憶體（預設開啟，建議設定至少 1 GB 容量）
    - 點擊［下一步］進入儲存掛載設定

    ![資源配置](../../img/ethpc/02建立容器叢集-資源配置.png)
...
4. **儲存掛載**
    ...
    ![儲存掛載](../../img/ethpc/06建立容器叢集-掛載home儲存.png)
...
6. 回到【分佈式訓練叢集】列表
    ...
    ![列表](../../img/ethpc/09建立容器叢集-列表建立中.png)